...
export default class LightboxOverlay extends Component {
    ...
    this._panResponder = PanResponder.create({
      ...
      onPanResponderMove: (evt, gestureState) => {
        ...
        if (gestureState.numberActiveTouches === 2) {
          ...
          const distant = this.distance(evt.nativeEvent.touches[0].pageX, evt.nativeEvent.touches[0].pageY, evt.nativeEvent.touches[1].pageX, evt.nativeEvent.touches[1].pageY);
  ...
  render() {
    ...
    const background = (<Animated.View style={[styles.background, { backgroundColor }, lightboxOpacityStyle]} />);
